...
class SignalDg:
	...
	def __pikeSearcher(self, lista, numero, aleluya):
		toBeReplaced = []
		positions = []
	...
	def __localMean(serlf, *args): # si solo se envio un argumento y es un trace se obtiene la media de todo el trazo; si son 3 argumentos devolvera la media de un trazo en los puntos dados 
